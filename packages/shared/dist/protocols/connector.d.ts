export type ConnectorAction = 'GET_RESOURCES' | 'GET_INTERFACES' | 'GET_HOTSPOT_USERS' | 'CREATE_HOTSPOT_USER' | 'UPDATE_HOTSPOT_USER' | 'DELETE_HOTSPOT_USER' | 'ENABLE_HOTSPOT_USER' | 'DISABLE_HOTSPOT_USER' | 'GET_ACTIVE_SESSIONS' | 'DISCONNECT_ACTIVE_SESSION' | 'GET_USER_PROFILES' | 'CREATE_USER_PROFILE' | 'GET_TRAFFIC_RATES' | 'PING_TEST';
